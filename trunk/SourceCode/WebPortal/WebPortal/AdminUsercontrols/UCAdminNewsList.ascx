<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCAdminNewsList.ascx.cs"
    Inherits="WebPortal.AdminUsercontrols.UCAdminNewsList" %>
<div id="data-table">
    <p>
...
if (str != "")
{
    ...
    str = str.Substring(0, po);
                ...
                <td style="width: 20%;">
                    <a href="AdminNewsManager.aspx?id=<%=news.IDTinTuc %>&type=delete">
                        <img src="images/ico_delete_16.png" class="icon16 fl-space2 usermanager-command"
                            alt="" title="Xóa" onclick="return confirm('Bạn có chắc chắn muốn xóa tin tức có mã <%=news.IDTinTuc %>?')" /></a>
        ...
        <input type="button" value="Tạo Mới" class="button" onclick="location.href='AdminNewsManager.aspx?id=-1&type=new'" />
    </form>
</div>
